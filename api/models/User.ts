...
var UserModel = {
  ...
  attributes: {
    ...
    increaseProgress: function (type, amount) {
      this.getBadge(type).progress += amount;
      return this.save()
    },
    decreaseProgress: function (type, amount) {
      this.getBadge(type).progress -= amount;
      return this.save()
    },
    unlockBadge: function (type) {
      this.getBadge(type).unlocked = true;
      return this.save()
    },
    lockBadge: function (type) {
  ...
  beforeCreate: function (user, cb) {
    user.badges = BadgeService.DEFAULT_BADGES;
    cb();
  },
