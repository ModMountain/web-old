...
module.exports.routes = {
    ...
    'GET    /profile/addons/liveEdit':                          'ProfileController.liveEdit',
    'POST   /profile/addons/liveEdit':                          'ProfileController.liveEditPOST',
    'GET    /profile/addons/:id':                               'ProfileController.viewAddon',
    'GET    /profile/addons/:id/edit':                          'ProfileController.liveEdit',
    'POST   /profile/addons/:id/edit':                          'ProfileController.liveEditPOST',
